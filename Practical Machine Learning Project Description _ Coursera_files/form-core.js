...
<script type="text/javascript">
  window.Global = {
    ...
    API_BASE_URL: 'https://class.coursera.org/predmachlearn-035/human_grading/api/',

    COURSE_BASE_URL: '//class.coursera.org/predmachlearn-035/',
    SITES_ASSETS_BASE_URL: 'https://dw0ugk4msqulk.cloudfront.net/988eb8fb5765c53e8ce1036531e532233b7f93d2/',

    humanGradingLinkHref: "https:\/\/class.coursera.org\/predmachlearn-035\/human_grading\/",
    humanGradingLinkText: "Peer Assessments",

    BACKBONE_BASE_URL: '//class.coursera.org/predmachlearn-035/human_grading/view/',
    BACKBONE_ROOT: '/predmachlearn-035/human_grading/view/',
...
<!--[if !IE]> --><script>document.getElementById("coursera-loading-js").style.display = 'block';</script><!-- <![endif]--><script>if (/zh/i.test(window.localStorage ? localStorage.getItem('locale') : '') || '{{ locale }}') {
  document.getElementById('get-browser-zh').style.display = 'block';
    ...
    <script src='https://dw0ugk4msqulk.cloudfront.net/988eb8fb5765c53e8ce1036531e532233b7f93d2/pages/hg/thirdparty/webshims/extras/modernizr-custom.js' ></script>
  <script src="https://dw0ugk4msqulk.cloudfront.net/988eb8fb5765c53e8ce1036531e532233b7f93d2/js/vendor/require.v2-1-1.js"></script><script data-baseurl="https://dw0ugk4msqulk.cloudfront.net/988eb8fb5765c53e8ce1036531e532233b7f93d2/" data-version="988eb8fb5765c53e8ce1036531e532233b7f93d2" data-timestamp='1449690337105' data-debug='0' data-locale="en" id="_require">if(document.getElementById('coursera-loading-js').style.display == 'block') {
  (function(el) {
     require.config({
       //enforceDefine: true,
       waitSeconds: 75,
      ...
      return JSON.parse("{\"id\":9108455,\"email_address\":\"douglas_mclean@yahoo.fr\",\"full_name\":\"Douglas McLean\",\"locale\":null,\"timezone\":\"Europe\\\/London\",\"access_group_id\":\"4\",\"registration_time\":\"1448519900\",\"last_access_time\":\"1450076979\",\"last_access_ip\":\"82.132.247.195\",\"signature_track_register_time\":\"1448519900\",\"email_announcement\":\"1\",\"email_forum\":\"1\",\"in_signature_track\":\"1\",\"wishes_proctored_exam\":null,\"first_name\":\"Douglas\",\"permissions\":[\"default\",\"allow_site_access\"],\"group\":\"Student\",\"anonymous\":false,\"forum_title\":\"Student\",\"signature_track_state\":4,\"verified_quizzes\":[\"89\",\"91\"],\"submitted_quizzes\":[\"89\",\"91\"],\"scheduled_proctored_exam\":null,\"last_chance_modal\":null,\"flexjoin_last_chance_modal\":null}");
  });
define('pages/spark/models/course.json', [], function(){
      return JSON.parse("{\"id\":975205,\"isPrivate\":false,\"type\":\"public\",\"name\":\"Practical Machine Learning\",\"instructor\":\"Jeff Leek, PhD, Roger D. Peng, PhD, Brian Caffo, PhD\",\"sessionName\":\"predmachlearn-035\",\"externalBaseURL\":\"https:\\\/\\\/www.coursera.org\\\/\",\"shortname\":\"predmachlearn\",\"host\":\"https:\\\/\\\/www.coursera.org\\\/\",\"assetUnversionedLink\":\"https:\\\/\\\/dw0ugk4msqulk.cloudfront.net\\\/\",\"cheggID\":\"\",\"hasLTI\":true,\"badgevilleDomain\":\"\",\"linkable\":false,\"universityShortname\":\"jhu\",\"signatureTrackStatus\":{\"signature_track_enabled\":1,\"signature_track_duration_left\":\"3 days and 16 hours\",\"signature_track_duration_left_days\":\"3 days\",\"signature_track_sign_up_now\":1,\"signature_track_last_chance_dialog\":1,\"flexjoin_last_chance_dialog\":0},\"courseURLs\":{\"log_in_link\":\"https:\\\/\\\/www.coursera.org\\\/login?post_redirect=https%3A%2F%2Fwww.coursera.org%2Flogin%3Fuser_action%3Dclass%26course_id%3D975205%26post_redirect%3Dhttps%253A%252F%252Fclass.coursera.org%252Fpredmachlearn-035%252Fauth%252Fauth_redirector%253Ftype%253Dlogin%2526subtype%253Dnormal%2526visiting%253D\",\"sign_up_link\":\"https:\\\/\\\/www.coursera.org\\\/signup?enroll_cid=975205&enroll_sn=predmachlearn&enroll_n=Practical Machine Learning\",\"view_course_info_link\":\"https:\\\/\\\/www.coursera.org\\\/course\\\/predmachlearn\",\"sign_up_link_cant_enroll\":\"https:\\\/\\\/www.coursera.org\\\/signup?post_redirect=https%3A%2F%2Fwww.coursera.org%2Fcourse%2Fpredmachlearn\"},\"courseBase\":\"https:\\\/\\\/class.coursera.org\\\/predmachlearn-035\\\/\",\"search\":true,\"hideWiki\":true,\"aceStartRegistrationDate\":\"Thu  1 Jan 1970  1:00 AM BST\",\"aceEndRegistrationDate\":\"Thu  1 Jan 1970  1:00 AM BST\",\"aceExamStartDate\":\"Thu  1 Jan 1970  1:00 AM BST\",\"aceExamEndDate\":\"Thu  1 Jan 1970  1:00 AM BST\",\"aceExamRules\":\"\",\"aceExamDuration\":\"\",\"aceBeforeExam\":false,\"aceAfterExam\":true,\"aceHours\":null,\"aceCreditType\":\"\",\"acePrice\":null,\"aceExamID\":null,\"aceEligible\":false,\"canRegisterForACE\":false,\"specialization\":{\"numCourse\":9,\"image\":\"https:\\\/\\\/s3.amazonaws.com\\\/coursera\\\/specializations\\\/jhudatascience\\\/logo_small.png\",\"id\":1,\"short_name\":\"jhudatascience\",\"name\":\"Data Science\"},\"supportForums\":true,\"textbooks\":\"\",\"inVideoQuizV2\":false,\"in_flexjoin\":0,\"honorCodeExtraText\":\"\",\"honorCodeCustomTitle\":\"\",\"honorCodeCustomButton\":\"\",\"studentAccessDisabled\":0,\"disableQQs\":false}");
  });
  define('pages/spark/models/navbar.json', [], function(){
      return JSON.parse("{\"items\":[{\"name\":\"Course\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Announcements\",\"icon\":\"home\",\"link_type\":\"circuit\",\"link_data\":\"class:index\"},{\"name\":\"Video Lectures\",\"icon\":\"lecture\",\"link_type\":\"circuit\",\"link_data\":\"lecture:index\"},{\"name\":\"\",\"icon\":\"\",\"link_type\":\"circuit\",\"link_data\":\"\"},{\"name\":\"Exercises\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Quizzes\",\"icon\":\"quiz\",\"link_type\":\"circuit\",\"link_data\":\"quiz:index\"},{\"name\":\"Course Project: Writeup\",\"icon\":\"assignment\",\"link_type\":\"circuit\",\"link_data\":\"human_grading:index\"},{\"name\":\"Course Project: Submission\",\"icon\":\"assignment\",\"link_type\":\"circuit\",\"link_data\":\"assignment:index\"},{\"name\":\"\",\"icon\":\"\",\"link_type\":\"circuit\",\"link_data\":\"\"},{\"name\":\"About the course\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Syllabus\",\"icon\":\"wiki\",\"link_type\":\"wiki\",\"link_data\":\"syllabus\"},{\"name\":\"\",\"icon\":\"\",\"link_type\":\"circuit\",\"link_data\":\"\"},{\"name\":\"Community\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Discussion Forums\",\"icon\":\"forum\",\"link_type\":\"circuit\",\"link_data\":\"forum:index\"},{\"name\":\"DSS Community Site\",\"icon\":\"\",\"link_type\":\"window_link\",\"link_data\":\"http:\\\/\\\/datasciencespecialization.github.io\\\/\"}]}");
  });
